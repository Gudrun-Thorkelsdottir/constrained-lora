...
def get_args():
    ...
    parser.add_argument('--output_dir', type=str, default="/projects/illinois/eng/cs/arindamb/gudrunt2/constrained-lora/out/ot-cfm-from-scratch/", help="output_directory")
    ...
    parser.add_argument('--total_steps', type=int, default=201, help="total training steps")  # Lipman et al uses 400k but double batch size
    ...
    parser.add_argument('--save_dir', type=str, default="/projects/illinois/eng/cs/arindamb/gudrunt2/constrained-lora/checkpoints/ot-cfm-from-scratch/")
